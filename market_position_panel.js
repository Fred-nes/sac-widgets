(function () {
  ...
  tmpl.innerHTML =
    ...
    "<div class='row'><label>Titel</label><input type='text' data-prop='title' data-type='string' value='Market Position (Current/Future)'/></div>" +
    "<div class='row'><label>Quellenangabe</label><input type='text' data-prop='sourceLabel' data-type='string' value='External Intelligence'/></div>" +
    ...
    "<div class='row'><label>Schriftgroesse (px)</label><input type='number' data-prop='fontSize' data-type='number' value='20'/></div>" +
    ...
    "<div class='section'>" +
    "<div class='section-title'>Akzent &amp; Icons</div>" +
    "<div class='row'><label>Akzentfarbe</label><div class='color-row'><input type='color' data-prop='accentColor' data-type='color' value='#185FA5'/><input type='text' class='color-hex' data-prop='accentColor' data-type='string' value='#185FA5'/></div></div>" +
    "</div>" +
  ...
  function MarketPositionStyling() {
    var instance = HTMLElement.call(this);
    return instance;
  }

  MarketPositionStyling.prototype = Object.create(HTMLElement.prototype);
  MarketPositionStyling.prototype.constructor = MarketPositionStyling;

  MarketPositionStyling.prototype.connectedCallback = function () {
  ...
  MarketPositionStyling.prototype._bindEvents = function () {
    var self = this;
  ...
  MarketPositionStyling.prototype.onCustomWidgetAfterUpdate = function (changed) {
    if (!this._root) return;
    var props = ["title", "sourceLabel", "showSource", "noDataText",
                 "titleColor", "valueColor", "fontSize", "sourceColor",
                 "accentColor", "bgColor", "showBorder", "borderColor", "borderRadius"];
  ...
  if (!customElements.get("com-custom-marketposition-styling")) {
    customElements.define("com-custom-marketposition-styling", MarketPositionStyling);
  }
