(function () {
  ...
  function buildHTML(score, opts) {
    ...
    html += "<path d='M 30 110 A 80 80 0 0 0 190 110' fill='none' stroke='" + opts.trackColor + "' stroke-width='20' stroke-linecap='round'/>";
    html += "<path d='M 30 110 A 80 80 0 0 0 190 110' fill='none' stroke='" + arcColor + "' stroke-width='20' stroke-linecap='round' stroke-dasharray='" + dashArray + "'/>";
  ...
  StrategicFitGauge.prototype._render = function () {
    ...
    this._container.innerHTML = buildHTML(this._score || 0, {
  ...
  StrategicFitGauge.prototype.onCustomWidgetAfterUpdate = function (changed) {
    ...
    if ("myDataBinding" in changed) {
      ...
      if (bd && bd.data && bd.data.length > 0) {
        var row = bd.data[0];
