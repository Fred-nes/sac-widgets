(function () {
  ...
  PredictedMargin.prototype._initDefaults = function () {
    ...
    this._aboveBg      = "#DFF5EA";
    this._aboveColor   = "#1E8E3E";
    this._aboveLabel   = "Above Threshold";
    this._belowBg      = "#FDECEA";
    this._belowColor   = "#D93025";
    this._belowLabel   = "Below Threshold";
  };
  ...
  PredictedMargin.prototype.onCustomWidgetAfterUpdate = function (changed) {
    ...
    if ("aboveBg"      in changed) this._aboveBg      = changed.aboveBg;
    if ("aboveColor"   in changed) this._aboveColor   = changed.aboveColor;
    if ("aboveLabel"   in changed) this._aboveLabel   = changed.aboveLabel;
    if ("belowBg"      in changed) this._belowBg      = changed.belowBg;
    if ("belowColor"   in changed) this._belowColor   = changed.belowColor;
    if ("belowLabel"   in changed) this._belowLabel   = changed.belowLabel;
  ...
  PredictedMargin.prototype._render = function () {
    ...
    if (this._value !== null) {
      ...
      badge.textContent      = above ? this._aboveLabel : this._belowLabel;
      badge.style.display    = "inline-block";
      badge.style.background = above ? this._aboveBg    : this._belowBg;
      badge.style.color      = above ? this._aboveColor : this._belowColor;
    } else {
      mv.textContent      = "-";
  ...
  if (!customElements.get("com-custom-predictedmargin")) {
