(function () {
  ...
  SmartQuotingInfo.prototype._readBinding = function (binding) {
    ...
    for (var i = 0; i < keys.length; i++) {
      ...
      // Measure: has "raw" property with a numeric value
      if (cell.raw !== undefined && cell.raw !== null && !isNaN(parseFloat(cell.raw))) {
        raw = cell.raw;
      } else if (cell.label !== undefined || cell.id !== undefined) {
        // Dimension: has "label" or "id"
        dims.push(cell.label || cell.id || "");
      }
    }
