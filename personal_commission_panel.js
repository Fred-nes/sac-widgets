(function () {
  ...
  tmpl.innerHTML =
    ...
    "<div class='row'><label>Titel</label><input type='text' data-prop='title' data-type='string' value='Personal Commission Forecast'/></div>" +
    "<div class='row'><label>Quellenangabe</label><input type='text' data-prop='sourceLabel' data-type='string' value='CRM (Restricted View)'/></div>" +
  ...
  function PersonalCommissionStyling() {
    var instance = HTMLElement.call(this);
    return instance;
  }

  PersonalCommissionStyling.prototype = Object.create(HTMLElement.prototype);
  PersonalCommissionStyling.prototype.constructor = PersonalCommissionStyling;

  PersonalCommissionStyling.prototype.connectedCallback = function () {
  ...
  PersonalCommissionStyling.prototype._bindEvents = function () {
    var self = this;
  ...
  PersonalCommissionStyling.prototype.onCustomWidgetAfterUpdate = function (changed) {
    if (!this._root) return;
    var props = ["title", "sourceLabel", "showSource", "noDataText",
                 "currencySymbol", "fontSize",
                 "titleColor", "valueColor", "sourceColor",
  ...
  if (!customElements.get("com-custom-personalcommission-styling")) {
    customElements.define("com-custom-personalcommission-styling", PersonalCommissionStyling);
  }
