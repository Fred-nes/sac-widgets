(function () {
  ...
  tmpl.innerHTML =
    ...
    "<div class='row'><label>Titel</label><input type='text' data-prop='title' data-type='string' value='Strategic Product Fit'/></div>" +
    "<div class='row'><label>Quellenangabe</label><input type='text' data-prop='sourceLabel' data-type='string' value='Internal Strategy Doc (PDF)'/></div>" +
    ...
    "<div class='row'><label>Schriftgroesse (px)</label><input type='number' data-prop='fontSize' data-type='number' value='22'/></div>" +
    ...
    "<div class='section'>" +
    "<div class='section-title'>Badge - Not Matched</div>" +
    "<div class='row'><label>Hintergrund</label><div class='color-row'><input type='color' data-prop='notMatchBg' data-type='color' value='#FDECEA'/><input type='text' class='color-hex' data-prop='notMatchBg' data-type='string' value='#FDECEA'/></div></div>" +
    "<div class='row'><label>Textfarbe</label><div class='color-row'><input type='color' data-prop='notMatchColor' data-type='color' value='#D93025'/><input type='text' class='color-hex' data-prop='notMatchColor' data-type='string' value='#D93025'/></div></div>" +
    "</div>" +

    "<div class='section'>" +
    "<div class='section-title'>Badge - Partial Match</div>" +
    "<div class='row'><label>Hintergrund</label><div class='color-row'><input type='color' data-prop='partialMatchBg' data-type='color' value='#FEF3CD'/><input type='text' class='color-hex' data-prop='partialMatchBg' data-type='string' value='#FEF3CD'/></div></div>" +
    "<div class='row'><label>Textfarbe</label><div class='color-row'><input type='color' data-prop='partialMatchColor' data-type='color' value='#C77700'/><input type='text' class='color-hex' data-prop='partialMatchColor' data-type='string' value='#C77700'/></div></div>" +
    "</div>" +

    "<div class='section'>" +
    "<div class='section-title'>Badge - Matched</div>" +
    "<div class='row'><label>Hintergrund</label><div class='color-row'><input type='color' data-prop='matchBg' data-type='color' value='#DFF5EA'/><input type='text' class='color-hex' data-prop='matchBg' data-type='string' value='#DFF5EA'/></div></div>" +
    "<div class='row'><label>Textfarbe</label><div class='color-row'><input type='color' data-prop='matchColor' data-type='color' value='#1E8E3E'/><input type='text' class='color-hex' data-prop='matchColor' data-type='string' value='#1E8E3E'/></div></div>" +
    "</div>" +

    "<div class='section'>" +
    "<div class='section-title'>Badge - Standard</div>" +
    "<div class='row'><label>Hintergrund</label><div class='color-row'><input type='color' data-prop='defaultBadgeBg' data-type='color' value='#E2E8F0'/><input type='text' class='color-hex' data-prop='defaultBadgeBg' data-type='string' value='#E2E8F0'/></div></div>" +
    "<div class='row'><label>Textfarbe</label><div class='color-row'><input type='color' data-prop='defaultBadgeColor' data-type='color' value='#4A5568'/><input type='text' class='color-hex' data-prop='defaultBadgeColor' data-type='string' value='#4A5568'/></div></div>" +
    "</div>" +
  ...
  function StrategicProductFitStyling() {
    var instance = HTMLElement.call(this);
    return instance;
  }

  StrategicProductFitStyling.prototype = Object.create(HTMLElement.prototype);
  StrategicProductFitStyling.prototype.constructor = StrategicProductFitStyling;

  StrategicProductFitStyling.prototype.connectedCallback = function () {
  ...
  StrategicProductFitStyling.prototype._bindEvents = function () {
    var self = this;
  ...
  StrategicProductFitStyling.prototype.onCustomWidgetAfterUpdate = function (changed) {
    if (!this._root) return;
    var props = ["title", "sourceLabel", "showSource", "noDataText",
                 "titleColor", "valueColor", "fontSize", "sourceColor",
                 "notMatchBg", "notMatchColor", "partialMatchBg", "partialMatchColor",
                 "matchBg", "matchColor", "defaultBadgeBg", "defaultBadgeColor",
  ...
  if (!customElements.get("com-custom-strategicproductfit-styling")) {
    customElements.define("com-custom-strategicproductfit-styling", StrategicProductFitStyling);
  }
