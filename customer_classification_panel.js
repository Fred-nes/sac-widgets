(function () {
  ...
  tmpl.innerHTML =
    ...
    "<div class='row'><label>Titel</label><input type='text' data-prop='title' data-type='string' value='Customer Classification'/></div>" +
    "<div class='row'><label>Quellenangabe</label><input type='text' data-prop='sourceLabel' data-type='string' value='SAP Sales Cloud'/></div>" +
    ...
    "<div class='row'><label>Wert Schriftgroesse</label><input type='number' data-prop='fontSize' data-type='number' value='28'/></div>" +
    ...
    "<div class='section'>" +
    "<div class='section-title'>Badge - Gold</div>" +
    "<div class='row'><label>Hintergrund</label><div class='color-row'><input type='color' data-prop='goldBg' data-type='color' value='#FEF3CD'/><input type='text' class='color-hex' data-prop='goldBg' data-type='string' value='#FEF3CD'/></div></div>" +
    "<div class='row'><label>Textfarbe</label><div class='color-row'><input type='color' data-prop='goldColor' data-type='color' value='#C77700'/><input type='text' class='color-hex' data-prop='goldColor' data-type='string' value='#C77700'/></div></div>" +
    "</div>" +

    "<div class='section'>" +
    "<div class='section-title'>Badge - Silver</div>" +
    "<div class='row'><label>Hintergrund</label><div class='color-row'><input type='color' data-prop='silverBg' data-type='color' value='#E8EAED'/><input type='text' class='color-hex' data-prop='silverBg' data-type='string' value='#E8EAED'/></div></div>" +
    "<div class='row'><label>Textfarbe</label><div class='color-row'><input type='color' data-prop='silverColor' data-type='color' value='#5F6B7A'/><input type='text' class='color-hex' data-prop='silverColor' data-type='string' value='#5F6B7A'/></div></div>" +
    "</div>" +

    "<div class='section'>" +
    "<div class='section-title'>Badge - Bronze</div>" +
    "<div class='row'><label>Hintergrund</label><div class='color-row'><input type='color' data-prop='bronzeBg' data-type='color' value='#F5E6DA'/><input type='text' class='color-hex' data-prop='bronzeBg' data-type='string' value='#F5E6DA'/></div></div>" +
    "<div class='row'><label>Textfarbe</label><div class='color-row'><input type='color' data-prop='bronzeColor' data-type='color' value='#8B4513'/><input type='text' class='color-hex' data-prop='bronzeColor' data-type='string' value='#8B4513'/></div></div>" +
    "</div>" +
  ...
  function CustomerClassificationStyling() {
    var instance = HTMLElement.call(this);
    return instance;
  }

  CustomerClassificationStyling.prototype = Object.create(HTMLElement.prototype);
  CustomerClassificationStyling.prototype.constructor = CustomerClassificationStyling;

  CustomerClassificationStyling.prototype.connectedCallback = function () {
  ...
  CustomerClassificationStyling.prototype._bindEvents = function () {
    var self = this;
  ...
  CustomerClassificationStyling.prototype.onCustomWidgetAfterUpdate = function (changed) {
    ...
    var props = ["title", "sourceLabel", "showSource", "noDataText",
                 ...
                 "goldBg", "goldColor", "silverBg", "silverColor",
                 "bronzeBg", "bronzeColor", "defaultBadgeBg", "defaultBadgeColor"];
  ...
  if (!customElements.get("com-custom-customerclassification-styling")) {
    customElements.define("com-custom-customerclassification-styling", CustomerClassificationStyling);
  }
